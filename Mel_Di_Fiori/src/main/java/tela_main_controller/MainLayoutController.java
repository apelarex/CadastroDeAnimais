...
public class MainLayoutController {
	...
	private String obterEstacao(int mes) {
		if (mes == 12 || mes <= 2) {
			return "Verão - Cavalos aproveitam os pastos verdes e se refrescam.";
		} else if (mes >= 3 && mes <= 5) {
			return "Outono - Cavalos começam a preparar o pelo para o frio.";
		} else if (mes >= 6 && mes <= 8) {
			return "Inverno - Cavalos mantêm-se ativos, mas precisam de cuidados especiais para o frio.";
		} else if (mes >= 9 && mes <= 11) {
			return "Primavera - Crescimento do pelo e aumento da energia dos cavalos.";
		}
		return "";
	 ...
	 * de colmeia.
	 */
	public void abrirListaCadastro() {
	    carregarTela("/telas/view/TelaCadastroColmeia.fxml");
	}
